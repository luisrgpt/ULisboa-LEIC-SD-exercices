...
To run using appassembler plugin:
  On Windows:
    target\appassembler\bin\ttt-ws http://localhost:8081 TTT http://localhost:8080/ttt-ws/endpoint
  On Linux:
    ./target/appassembler/bin/ttt-ws http://localhost:8081 TTT http://localhost:8080/ttt-ws/endpoint
