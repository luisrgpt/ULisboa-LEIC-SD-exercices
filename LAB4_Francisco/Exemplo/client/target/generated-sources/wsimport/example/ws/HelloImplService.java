 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://ws.example/", wsdlLocation = "http://localhost:8080/hello-ws/endpoint?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/hello-ws/endpoint?WSDL");
